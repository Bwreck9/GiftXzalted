...
- **Gift List Management:** Separated "Gift Ideas" (manual) and "Generated Ideas" (AI). Settings dropdown for list operations. "Add to list" functionality for AI suggestions. "Generate ideas" button triggers AI recommendations (200 tokens per generation, 10 ideas). Session-based duplicate prevention for AI suggestions.
